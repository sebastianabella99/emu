...
class BaseComponent {
    constructor(router, auth, http, workflow, obser, formBuilder, rules, catalogo, deviceService, route, postMessagesService, sanitizer, zipString, cripto, translate) {
        ...
        this.translate.setDefaultLang(`i18n_${this.obser.lastValue(_CONST__WEBPACK_IMPORTED_MODULE_5__["STEP_ID"])}?lenguaje=${this.obser.lastValue(_CONST__WEBPACK_IMPORTED_MODULE_5__["LENGUAJE"])}&pais=${this.obser.lastValue(_CONST__WEBPACK_IMPORTED_MODULE_5__["PAIS"])}`);
        ...
        this.payload = this.obser.lastValue(_CONST__WEBPACK_IMPORTED_MODULE_5__["PAYLOAD"]);
