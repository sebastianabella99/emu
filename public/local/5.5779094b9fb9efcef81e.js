        ...
        setTimeout(() => {
            html_to_image__WEBPACK_IMPORTED_MODULE_3___default.a.toBlob(this.screen.nativeElement, {
                ...
                this.screen2.nativeElement.onload = () => {
                    let height = 0;
                    let width = 0;
                    if (this.screen2.nativeElement.height > 1508 || this.screen2.nativeElement.width > 754) {
                        const factorX = this.screen2.nativeElement.height / 1508;
                        const factorY = this.screen2.nativeElement.width / 754;
                        ...
                        console.log('con escala');
                    }
                    else {
                        height = this.screen2.nativeElement.height;
                        width = this.screen2.nativeElement.width;
                        console.log('sin escala');
                    }
